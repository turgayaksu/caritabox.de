    ...
    <div className="flex h-full min-h-[800px] w-screen items-center justify-center">
      <div className="w-4/5 rounded-lg border border-slate-200/70 bg-white p-6 shadow-xl dark:border-slate-800 dark:bg-slate-900 md:w-4/6 lg:w-3/6 xl:w-2/5">
        <div className="text-center text-xl font-semibold">
          Caritabox Kundenkonto
        </div>
        <div className="mt-2 text-center text-sm text-slate-600">
          Wenn Sie bereits ein Kundenkonto angelegt haben, können Sie sich hier
          einloggen. Sollten Sie noch kein Kundenkonto haben, können Sie sich
          <Link href="/register" className="ml-1 underline">
            hier ein neues Kundenkonto anlegen.
          </Link>
        </div>

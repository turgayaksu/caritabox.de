        ...
        <div className="container mx-auto flex flex-col space-y-8 px-4 lg:px-0">
          ...
          <div className="rounded-md bg-slate-100 pb-10 pl-8 pr-14 pt-4 dark:bg-slate-800">
            <div className="flex items-center">
              <div className="relative flex items-center text-primary-600">
                <div className="flex h-8 w-8 items-center justify-center rounded-full border border-primary-600 transition duration-500 ease-in-out">
                  1
                </div>
                <div className="absolute left-1/2 top-10 -translate-x-1/2 text-center text-xs font-medium text-primary-600">
                  Pflegetüte
                </div>
              </div>
              <div className="flex-auto border-t-2 border-primary-600 transition duration-500 ease-in-out"></div>
              <div className="relative flex items-center text-white">
                <div className="flex h-8 w-8 items-center justify-center rounded-full border border-primary-600 bg-primary-600 transition duration-500 ease-in-out">
                  2
                </div>
                <div className="absolute left-1/2 top-10 -translate-x-1/2 text-center text-xs font-medium text-primary-600">
                  Versicherter
